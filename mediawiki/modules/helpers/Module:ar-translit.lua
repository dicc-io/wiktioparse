...
local dotless_head_of_khah = U(0x6E1)
...
local tt = {
	...
	[dotless_head_of_khah]="", --sukūn - no vowel
	-- ligatures
	["ﻻ"]="lā",
	["ﷲ"]="llāh",
	-- taṭwīl
...
local before_diacritic_checking_subs = {
	...
	{waaw .. dotless_head_of_khah .. alif, waaw .. dotless_head_of_khah},
...
function export.tr(text, lang, sc, omit_i3raab, gray_i3raab, force_translit)
	...
	text = rsub(text, Damma .. waaw .. "([^" .. fatHataan .. Dammataan .. kasrataan .. fatHa .. Damma .. kasra .. shadda .. sukuun .. dotless_head_of_khah .. dagger_alif .. "])", "ū%1")
	text = rsub(text, Damma .. waaw .. "$", "ū")
	-- kasra + yaa not followed by a diacritic (or ū from prev step) is ī, otherwise y
	text = rsub(text, kasra .. yaa .. "([^" .. fatHataan .. Dammataan .. kasrataan .. fatHa .. Damma .. kasra .. shadda .. sukuun .. dotless_head_of_khah .. dagger_alif .. "ū])", "ī%1")
...
local has_diacritics_subs = {
	...
	{"[" .. lconsonants .. alif .. "]([" .. fatHataan .. Dammataan .. kasrataan .. fatHa .. Damma .. kasra .. sukuun .. dotless_head_of_khah .. dagger_alif .. "])", "%1"},
	...
	-- remove diacritics
	{"[" .. fatHataan .. Dammataan .. kasrataan .. fatHa .. Damma .. kasra .. sukuun .. dotless_head_of_khah .. dagger_alif .. "]", ""},
